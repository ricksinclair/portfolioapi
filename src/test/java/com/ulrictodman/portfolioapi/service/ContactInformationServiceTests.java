...
import com.ulrictodman.portfolioapi.enumeration.ContactRole;
...
public class ContactInformationServiceTests {
    ...
    ContactInformation testContact1;

    ContactInformation testContact2;
    ...
    @Test
    public void addGetContactInfoTest() {
    ...
    public void whenInvalidIdProvidedOnDelete_NotFoundExceptionIsThrown() {
        ...
        Exception exception = assertThrows(NotFoundException.class, () -> {
            contactInformationService.delete(39);
        });
    ...
    public void whenInvalidIdProvidedOnGet_NotFoundExceptionIsThrown() {
        Exception exception = assertThrows(NotFoundException.class, () -> {
            contactInformationService.get(39);
        });
    ...
    @Test
    public void afterInsertingThenDeletingThenTryingToRetrieveById_NotFoundExceptionIsThrown() {
        testContact1 = contactInformationService.save(testContact1);
        contactInformationService.delete(testContact1.getId());
        Exception exception = assertThrows(NotFoundException.class, () -> {
            contactInformationService.get(testContact1.getId());
        });
    ...
    @Test
    public void afterAddingAndUpdatingValue_UpdatedValueRetrievedFromDb() {
        testContact1 = contactInformationService.save(testContact1);
